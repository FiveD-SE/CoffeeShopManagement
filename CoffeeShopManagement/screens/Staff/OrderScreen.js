                    ...
                    <View style={styles.deliInforWrapper}>
                        <View style={{ flexDirection: 'column' }}>
                            <Text style={styles.orderText}>
                                ...
                                <Text style={{ fontFamily: 'lato-bold' }}>{selectedOrder.orderOwner}</Text>
                            </Text>
                            <Text style={styles.orderText}>
                                <Text>SDT người nhận: </Text>
                                <Text style={{ fontFamily: 'lato-bold' }}>{selectedOrder.orderOwnerPhone}</Text>
                            </Text>
                            <Text style={styles.orderText}>
                                <Text>Trạng thái: </Text>
                                <Text style={{ fontFamily: 'lato-bold' }}>{selectedOrder.orderState}</Text>
                            </Text>
                            <Text style={styles.orderText}>
                                <Text>Trạng thái thanh toán: </Text>
                                <Text style={{ fontFamily: 'lato-bold', color: selectedOrder.orderPaymentState === "Chưa thanh toán" ? "#f61a3d" : "#4ecb71" }}>{selectedOrder.orderPaymentState}</Text>
                            </Text>
                        </View>

                        <View>
                            <Image style={{ width: 48, height: 48 }} source={selectedOrder.orderType === 'Giao hàng' ? require('../../assets/images/delivery_icon.png') : require('../../assets/images/takeaway_icon.png')} />
                        </View>
                    </View>
                </View>
            </View>
