    ...
    return (
        <SafeAreaView style={styles.container}>
            <ScrollView contentContainerStyle={styles.scrollViewContent}>
                <Section title={"Tất cả các chi nhánh"}>
                    {allBranch.length === 0 ? (
                        ...
                        allBranch.map((item) => renderBranchItem(item))
                    )}
                </Section>
            </ScrollView>
        </SafeAreaView>
...
export default AdminSelectBranchScreen;
