import { StyleSheet, Text, View, Image, FlatList, useWindowDimensions, Animated, TouchableOpacity } from "react-native";
...
const splashData = [
    {
        ...
        description: 'Cà phê là tất cả những gì bạn cần để bắt đầu một ngày mới',
        image: require("../../assets/splashScreenImage/coffee-cup.png")
    },
    {
        id: '2',
        title: 'Uống Gì Hôm Nay?',
        description: 'Dạo qua menu đa dạng với hàng chục loại thức uống để lựa chọn',
        image: require("../../assets/splashScreenImage/drink.png")
    },
    {
        id: '3',
        title: 'Ưu Đãi Hấp Dẫn',
        description: 'Khám phá những ưu đãi đặc biệt cho thức uống yêu thích của bạn',
...
const OnBoardingScreen = () => {
    ...
    return (
        <View style={styles.container}>
            <Image style={{ flex: 0.2, justifyContent: 'center', resizeMode: 'contain' }} source={require("../../assets/splashScreenImage/AppLogo.png")} />
            ...
            <View style={styles.bottomContainer}>
                {showBackButton && (
                    <TouchableOpacity style={styles.backButton} onPress={scrollBack}>
                ...
                {showSkipButton && (
                    <TouchableOpacity style={styles.backButton} onPress={goToSignIn}>
                        <Text style={{ fontSize: 18, fontWeight: 500 }}> Bỏ qua </Text>
                    </TouchableOpacity>
                )}
