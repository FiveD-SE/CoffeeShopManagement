        ...
        try {
            ...
            if (userVoucherSnap.exists()) {
                ...
                await setDoc(userVoucherRef, {
                    userId: userData.id,
                    voucherId: [
                        { id: voucherDetails.id, quantity: 1, dateCreated },
                    ],
                });
            }

            const newCredit =
                userData.credit - voucherDetails.voucherExchangePrice;
            ...
            Alert.alert(
                "Error",
                "Failed to exchange voucher. Please try again."
            );
        }
    };
                ...
                <View style={styles.main}>
                    ...
                    <View style={{ flexDirection: "row" }}>
                        ...
                        <View style={styles.expirationDateContainer}>
                            ...
                            >
                                {formatCurrency(
                                    voucherDetails.minimumOrderPrice
                                )}
                            </Text>
                        </View>
                    </View>
