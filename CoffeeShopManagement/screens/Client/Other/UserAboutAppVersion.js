    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <View style={styles.content}>
                ...
                <Text style={styles.sectionTitle}>Chào Mừng Bạn Đến Với Ứng Dụng Của Chúng Tôi</Text>
                <Text style={styles.sectionContent}>
                    Chúng tôi rất vui mừng giới thiệu phiên bản đầu tiên của ứng dụng quản lý quán cà phê. Ứng dụng này được thiết kế nhằm giúp bạn quản lý quán cà phê một cách dễ dàng và hiệu quả.
                </Text>
                <Text style={styles.sectionTitle}>Các Tính Năng Chính:</Text>
                <Text style={styles.sectionContent}>
                    - Giao diện thân thiện với người dùng để quản lý đơn hàng và kho hàng.
                ...
                <Text style={styles.sectionContent}>
                    Vì đây là phiên bản đầu tiên, chúng tôi cam kết sẽ không ngừng cải tiến. Chúng tôi đang làm việc để thêm nhiều tính năng và cải thiện trải nghiệm của bạn. Phản hồi của bạn rất quan trọng đối với chúng tôi, và chúng tôi khuyến khích bạn chia sẻ ý kiến và đề xuất của mình.
                </Text>
