        ...
        const fetchUserData = async () => {
            ...
            if (userDoc.exists()) {
                ...
                if (rankPoints >= 500) {
                    ...
                    rank = "Vàng";
                    beansToNextRank = 500 - rankPoints;
                } else if (rankPoints >= 200) {
                    rank = "Bạc";
                    beansToNextRank = 300 - rankPoints;
                } else if (rankPoints >= 100) {
                    rank = "Đồng";
                    beansToNextRank = 200 - rankPoints;
                } else {
                    beansToNextRank = 100 - rankPoints;
                }
                ...
                <View style={styles.main}>
                    <View style={styles.row}>
                        <Pressable
                            ...
                            onPress={() =>
                                navigation.navigate("Rank", { rank: userRank })
                            }
                        >
                            <Image
