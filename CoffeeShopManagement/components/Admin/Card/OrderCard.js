...
const OrderCard = ({ orderId, status, total, date }) => {
    ...
    return (
        <View style={styles.orderContainer} testID="orderCard">
            <View style={styles.orderDetails}>
                <View style={styles.orderId}>
                    <View style={{ flex: 1, flexDirection: "row" }}>
                        <Text style={styles.orderIdText}>Đơn hàng:</Text>
                        <Text style={styles.orderIdValue} testID="orderIdValue">
                ...
                <View style={styles.orderTotal}>
                    <Text style={styles.orderDate} testID="orderDate">
                        {formatDate(date)}
                    </Text>
                    <Text
                        style={styles.orderTotalValue}
                        testID="orderTotalValue"
                    >
